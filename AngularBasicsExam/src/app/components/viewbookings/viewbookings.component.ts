...
export class ViewbookingsComponent {
  ...
  constructor(protected loginService: LoginService,
    ...
    this.bookings = this.focusedUser.bookings.filter(booking => booking.date === this.focusedDate);
  }
  ...
  deleteBooking(bookingToDelete: Booking) {
    ...
    this.focusedUser.bookings = this.focusedUser.bookings.filter(booking => booking !== bookingToDelete);
    this.bookings = this.focusedUser.bookings.filter(booking => booking.date === this.focusedDate);
